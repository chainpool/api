...
*Defined in [api/src/types/storage.ts:76](https://github.com/polkadot-js/api/blob/2493442a2e/packages/api/src/types/storage.ts#L76)*
...
*Defined in [api/src/types/storage.ts:77](https://github.com/polkadot-js/api/blob/2493442a2e/packages/api/src/types/storage.ts#L77)*
