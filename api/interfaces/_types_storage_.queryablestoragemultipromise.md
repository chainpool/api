...
*Defined in [api/src/types/storage.ts:76](https://github.com/polkadot-js/api/blob/6dfebbb9fe/packages/api/src/types/storage.ts#L76)*
...
*Defined in [api/src/types/storage.ts:77](https://github.com/polkadot-js/api/blob/6dfebbb9fe/packages/api/src/types/storage.ts#L77)*
