...
*Defined in [api/src/types/storage.ts:42](https://github.com/polkadot-js/api/blob/8bea5e5a3b/packages/api/src/types/storage.ts#L42)*
...
*Defined in [api/src/types/storage.ts:43](https://github.com/polkadot-js/api/blob/8bea5e5a3b/packages/api/src/types/storage.ts#L43)*
