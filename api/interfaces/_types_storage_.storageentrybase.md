...
*Defined in [api/src/types/storage.ts:31](https://github.com/polkadot-js/api/blob/099cf5a351/packages/api/src/types/storage.ts#L31)*
...
*Defined in [api/src/types/storage.ts:35](https://github.com/polkadot-js/api/blob/099cf5a351/packages/api/src/types/storage.ts#L35)*
