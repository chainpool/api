...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/099cf5a351/packages/api/src/submittable/createSubmittable.ts#L17)*
