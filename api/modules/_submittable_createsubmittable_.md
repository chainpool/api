...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/8bea5e5a3b/packages/api/src/submittable/createSubmittable.ts#L17)*
