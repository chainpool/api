...
*Defined in [api/src/util/decorate.ts:13](https://github.com/polkadot-js/api/blob/8bea5e5a3b/packages/api/src/util/decorate.ts#L13)*
...
*Defined in [api/src/util/decorate.ts:44](https://github.com/polkadot-js/api/blob/8bea5e5a3b/packages/api/src/util/decorate.ts#L44)*
