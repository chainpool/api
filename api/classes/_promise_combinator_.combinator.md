...
*Defined in [api/src/promise/Combinator.ts:29](https://github.com/polkadot-js/api/blob/2eb09374bc/packages/api/src/promise/Combinator.ts#L29)*
...
*Defined in [api/src/promise/Combinator.ts:79](https://github.com/polkadot-js/api/blob/2eb09374bc/packages/api/src/promise/Combinator.ts#L79)*
