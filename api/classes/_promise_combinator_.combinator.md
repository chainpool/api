...
*Defined in [api/src/promise/Combinator.ts:29](https://github.com/polkadot-js/api/blob/8bea5e5a3b/packages/api/src/promise/Combinator.ts#L29)*
...
*Defined in [api/src/promise/Combinator.ts:79](https://github.com/polkadot-js/api/blob/8bea5e5a3b/packages/api/src/promise/Combinator.ts#L79)*
