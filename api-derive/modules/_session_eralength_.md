...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/8bea5e5a3b/packages/api-derive/src/session/eraLength.ts#L13)*
