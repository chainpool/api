...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/503c2b3c63/packages/api-derive/src/session/eraLength.ts#L13)*
