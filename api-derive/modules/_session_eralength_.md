...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/e5c2c6a228/packages/api-derive/src/session/eraLength.ts#L13)*
