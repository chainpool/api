...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/f1b6268784/packages/api-derive/src/session/eraLength.ts#L13)*
