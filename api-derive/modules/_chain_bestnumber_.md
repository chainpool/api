...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:25](https://github.com/polkadot-js/api/blob/099cf5a351/packages/api-derive/src/chain/bestNumber.ts#L25)*
