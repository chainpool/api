...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:25](https://github.com/polkadot-js/api/blob/8bea5e5a3b/packages/api-derive/src/chain/bestNumber.ts#L25)*
