...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/5b96d52fa6/packages/api-derive/src/session/sessionProgress.ts#L13)*
