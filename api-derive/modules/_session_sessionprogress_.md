...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/34101ec12b/packages/api-derive/src/session/sessionProgress.ts#L13)*
