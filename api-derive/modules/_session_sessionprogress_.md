...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/6a9e3d80f1/packages/api-derive/src/session/sessionProgress.ts#L13)*
