...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/21802664b8/packages/api-derive/src/session/sessionProgress.ts#L13)*
