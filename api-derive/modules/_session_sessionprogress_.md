...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/b4306cb60a/packages/api-derive/src/session/sessionProgress.ts#L13)*
