...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/622682b4ef/packages/api-derive/src/session/sessionProgress.ts#L13)*
