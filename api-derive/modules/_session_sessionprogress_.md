...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/eea4c8775e/packages/api-derive/src/session/sessionProgress.ts#L13)*
