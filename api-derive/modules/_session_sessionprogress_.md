...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/ad6b8280a2/packages/api-derive/src/session/sessionProgress.ts#L13)*
