...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/eea4c8775e/packages/api-derive/src/session/eraProgress.ts#L13)*
