...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/622682b4ef/packages/api-derive/src/session/eraProgress.ts#L13)*
