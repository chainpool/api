...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/21802664b8/packages/api-derive/src/session/eraProgress.ts#L13)*
