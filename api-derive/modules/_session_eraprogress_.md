...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/ff52876920/packages/api-derive/src/session/eraProgress.ts#L13)*
