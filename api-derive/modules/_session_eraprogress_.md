...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/e900d1d657/packages/api-derive/src/session/eraProgress.ts#L13)*
