...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/503c2b3c63/packages/api-derive/src/session/eraProgress.ts#L13)*
