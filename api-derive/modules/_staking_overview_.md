...
*Defined in [packages/api-derive/src/staking/overview.ts:16](https://github.com/polkadot-js/api/blob/b4306cb60a/packages/api-derive/src/staking/overview.ts#L16)*
