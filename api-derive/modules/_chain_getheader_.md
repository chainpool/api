...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/34101ec12b/packages/api-derive/src/chain/getHeader.ts#L27)*
