...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/f1b6268784/packages/api-derive/src/chain/getHeader.ts#L27)*
