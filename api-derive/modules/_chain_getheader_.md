...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/8bea5e5a3b/packages/api-derive/src/chain/getHeader.ts#L27)*
