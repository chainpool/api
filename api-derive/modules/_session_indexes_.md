...
*Defined in [packages/api-derive/src/session/indexes.ts:79](https://github.com/polkadot-js/api/blob/34101ec12b/packages/api-derive/src/session/indexes.ts#L79)*
