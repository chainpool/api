...
import { BlockNumber, Hash, ReferendumIndex, Scheduled } from '@chainx-v2/types/interfaces';
...
import { Option, Vec, u64 } from '@chainx-v2/types';
import { isFunction, stringToHex } from '@chainx-v2/util';
