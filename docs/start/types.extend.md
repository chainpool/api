...
There is a the [recommendation](install.md#betas) to use a `@chainx-v2/api@beta` should you wish to track the master branches of Polkadot or Substrate, since master changes for the addition of new types do not make it into a stable release immediately.
