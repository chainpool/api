...
class Enum {
  ...
  toU8a(isBare) {
    const index = (0, _classPrivateFieldLooseBase2.default)(this, _indexes)[_indexes][(0, _classPrivateFieldLooseBase2.default)(this, _index)[_index]];

    return (0, _util.u8aConcat)(new Uint8Array([index]), (0, _classPrivateFieldLooseBase2.default)(this, _raw)[_raw].toU8a(isBare));
  }
