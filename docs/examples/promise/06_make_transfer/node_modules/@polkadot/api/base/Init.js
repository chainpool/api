...
class Init extends _Decorate.default {
  ...
  _adjustBundleTypes(chain, specName) {
    // adjust known type aliases
    this.registry.knownTypes.typesAlias = (0, _typesKnown.getSpecAlias)(this.registry, chain, specName); // FIXME For the first round, we are not adjusting the user-injected RPCs
