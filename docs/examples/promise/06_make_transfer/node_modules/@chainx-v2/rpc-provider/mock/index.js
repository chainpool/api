...
var _static = _interopRequireDefault(require("@chainx-v2/metadata/Metadata/static"));

var _jsonrpc = _interopRequireDefault(require("@chainx-v2/types/interfaces/jsonrpc"));

var _testing = _interopRequireDefault(require("@chainx-v2/keyring/testing"));

var _Header = _interopRequireDefault(require("@chainx-v2/types/json/Header.004.json"));

var _SignedBlock004Immortal = _interopRequireDefault(require("@chainx-v2/types/json/SignedBlock.004.immortal.json"));
...
class Mock {
  ...
  makeBlockHeader() {
    ...
    const header = this.registry.createType('Header', {
      ...
      extrinsicsRoot: (0, _crypto.randomAsU8a)(),
      number: blockNumber,
