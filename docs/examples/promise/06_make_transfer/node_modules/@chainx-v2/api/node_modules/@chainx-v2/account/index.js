...
var _crypto = require("@chainx-v2/crypto");

var _keyring = require("@chainx-v2/keyring");

var _defaults = require("@chainx-v2/keyring/pair/defaults");

var _util = require("@chainx-v2/util");

var _u8aFrom = _interopRequireDefault(require("./u8aFrom"));

var _decode = _interopRequireDefault(require("@chainx-v2/keyring/pair/decode"));

var _encode = _interopRequireDefault(require("@chainx-v2/keyring/pair/encode"));
...
class Account {
  ...
  sign(message) {
    return (0, _crypto.naclSign)(message, this._keyPair);
  }
  /**
    * @name verify
  ...
  verify(message, signature) {
    return (0, _crypto.naclVerify)(message, signature, this._keyPair.publicKey);
  }
  /**
    * @name from
  ...
  static from(unknow) {
    ...
    if (typeof unknow !== 'string') {
      ...
      if (u8a.length === 32) {
        return new Account((0, _crypto.naclKeypairFromSeed)(u8a));
      } else if (u8a.length === 64) {
        return new Account((0, _crypto.naclKeypairFromSecret)(u8a));
      } else {
  ...
  static fromMnemonic(mnemonic) {
    const seed = (0, _crypto.mnemonicToMiniSecret)(mnemonic);
    return new Account((0, _crypto.naclKeypairFromSeed)(seed));
  }
  /**
    * @name fromPrivateKey
    * @summary generate account using mnemonic
  ...
  static fromSeed(seedLike) {
    ...
    return new Account((0, _crypto.naclKeypairFromSeed)(seedU8a));
  }
  /***
     *
  ...
  static fromSecretKey(secretKey) {
    ...
    return new Account((0, _crypto.naclKeypairFromSecret)(secretKeyU8a));
  }
  /**
    * @name fromPkcs8
    * @summary generate account using mnemonic
  ...
  static generate() {
    const random = (0, _crypto.randomAsU8a)(32);
    return new Account((0, _crypto.naclKeypairFromSeed)(random));
  }
  /**
    * @name newMnemonic
  ...
  static newMnemonic() {
    return (0, _crypto.mnemonicGenerate)();
  }
  /**
  ...
  static isMnemonicValid(mnemonic) {
    return (0, _crypto.mnemonicValidate)(mnemonic);
  }
  /**
    * @name isAddressValid
