...
describe('signatureVerify', () => {
  ...
  it('throws on invalid signature length', () => {
    expect(() => (0, _index.signatureVerify)(MESSAGE, new Uint8Array(32), ADDR_ED)).toThrow('Invalid signature length, expected [64..66] bytes, found 32');
  });
  describe('verifyDetect', () => {
    it('verifies an ed25519 signature', () => {
      expect((0, _index.signatureVerify)(MESSAGE, SIG_ED, ADDR_ED)).toEqual({
        crypto: 'ed25519',
        isValid: true
      });
    });
    it('verifies an ecdsa signature', () => {
      expect((0, _index.signatureVerify)(MESSAGE, SIG_EC, ADDR_EC)).toEqual({
        crypto: 'ecdsa',
        isValid: true
      });
    });
    it('verifies an sr25519 signature', () => {
      expect((0, _index.signatureVerify)(MESSAGE, SIG_SR, ADDR_SR)).toEqual({
        crypto: 'sr25519',
        isValid: true
      });
    });
    it('allows various inputs', () => {
      expect((0, _index.signatureVerify)((0, _util.stringToU8a)(MESSAGE), (0, _util.hexToU8a)(SIG_ED), (0, _address.decodeAddress)(ADDR_ED))).toEqual({
        crypto: 'ed25519',
        isValid: true
      });
    });
    it('fails on an invalid signature', () => {
      expect((0, _index.signatureVerify)(MESSAGE, SIG_SR, ADDR_ED)).toEqual({
        crypto: 'none',
        isValid: false
      });
    });
  ...
  describe('verifyMultisig', () => {
    it('verifies an ed25519 signature', () => {
      expect((0, _index.signatureVerify)(MESSAGE, MUL_ED, ADDR_ED)).toEqual({
        crypto: 'ed25519',
        isValid: true
      });
    });
    it('verifies an ecdsa signature', () => {
      expect((0, _index.signatureVerify)(MESSAGE, MUL_EC, ADDR_EC)).toEqual({
        crypto: 'ecdsa',
        isValid: true
      });
    });
    it('verifies an sr25519 signature', () => {
      expect((0, _index.signatureVerify)(MESSAGE, MUL_SR, ADDR_SR)).toEqual({
        crypto: 'sr25519',
        isValid: true
      });
    });
    it('fails on an invalid signature', () => {
      expect((0, _index.signatureVerify)(MESSAGE, MUL_SR, ADDR_ED)).toEqual({
        crypto: 'sr25519',
        isValid: false
      });
    });
