...
var _fromPath = _interopRequireDefault(require("@chainx-v2/crypto/key/fromPath"));

var _key = require("@chainx-v2/crypto/key");
...
describe('naclOpen', () => {
  it('opens a sealed message by the sender', () => {
    ...
    const {
      nonce,
      sealed
    } = (0, _index.naclSeal)(message, senderBox.secretKey, receiverBox.publicKey);
    expect((0, _index.naclOpen)(sealed, nonce, senderBox.publicKey, receiverBox.secretKey)).toEqual(message);
  });
  it('polkadot does double ratchet', () => {
    var _opened, _opened2, _opened3;

    const sender = (0, _index.naclKeypairFromString)('sender');
    const receiver = (0, _index.naclKeypairFromString)('receiver'); // Make id key for identifying each other
    ...
    const receiverIdBoxKey = (0, _index.naclBoxKeypairFromSecret)(receiverIdKey.secretKey);
    ...
    const senderIdBoxKey = (0, _index.naclBoxKeypairFromSecret)(senderIdKey.secretKey);
    const message = new Uint8Array([1, 2, 3, 4, 5, 4, 3, 2, 1]);
    const {
      nonce,
      sealed
    } = (0, _index.naclSeal)(message, senderIdBoxKey.secretKey, receiverIdBoxKey.publicKey);
    ...
    let opened = (0, _index.naclOpen)(sealed, nonce, senderIdBoxKey.publicKey, receiverIdBoxKey.secretKey);
    ...
    const receiverIdBoxKey2 = (0, _index.naclBoxKeypairFromSecret)(receiverIdKey2.secretKey);
    ...
    const senderIdBoxKey2 = (0, _index.naclBoxKeypairFromSecret)(senderIdKey2.secretKey);
    const message2 = new Uint8Array([1, 2, 3, 4, 5, 4, 3, 2, 1]);
    let ctx = (0, _index.naclSeal)(message2, senderIdBoxKey2.secretKey, receiverIdBoxKey2.publicKey);
    const sealed2 = ctx.sealed;
    const nonce2 = ctx.nonce;
    console.log(`Sender sends encrypted message to receiver ${sealed.toString()}, ${nonce.toString()}`); // Receiver opens encrypted message from the sender

    opened = (0, _index.naclOpen)(sealed2, nonce2, senderIdBoxKey2.publicKey, receiverIdBoxKey2.secretKey);
    ...
    const receiverIdBoxKey2One = (0, _index.naclBoxKeypairFromSecret)(receiverIdBoxKey2.secretKey);
    ...
    const senderIdBoxKey2One = (0, _index.naclBoxKeypairFromSecret)(senderIdBoxKey2.secretKey);
    const message3 = new Uint8Array([1, 2, 3, 4, 5, 4, 3, 2, 1]);
    ctx = (0, _index.naclSeal)(message3, senderIdBoxKey2One.secretKey, receiverIdBoxKey2One.publicKey);
    ...
    opened = (0, _index.naclOpen)(sealed2, nonce2, senderIdBoxKey2One.publicKey, receiverIdBoxKey2One.secretKey);
  ...
  it('returns null on invalid', () => {
    expect((0, _index.naclOpen)(new Uint8Array(), new Uint8Array(24), new Uint8Array(32), new Uint8Array(32))).toEqual(null);
  });
});