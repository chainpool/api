...
describe('String padStart', () => {
  let stringStart;
  beforeEach(() => {
    stringStart = String.prototype.padStart; // eslint-disable-next-line no-extend-native,@typescript-eslint/no-explicit-any,@typescript-eslint/no-unsafe-assignment
