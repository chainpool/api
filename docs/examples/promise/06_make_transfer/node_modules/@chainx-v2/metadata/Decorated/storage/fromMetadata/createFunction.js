...
var _codec = require("@chainx-v2/types/codec");

var _create = require("@chainx-v2/types/create");
...
function createPrefixedKey({
  ...
  return (0, _util.u8aConcat)((0, _crypto.xxhashAsU8a)(prefix, 128), (0, _crypto.xxhashAsU8a)(method, 128));
...
function extendLinkedMap(registry, itemFn, storageFn, stringKey, hasher, metaVersion) {
  const key = metaVersion <= 8 ? hasher(`head of ${stringKey}`) : (0, _util.u8aConcat)((0, _crypto.xxhashAsU8a)(itemFn.prefix, 128), (0, _crypto.xxhashAsU8a)(`HeadOf${itemFn.method}`, 128));
