...
var _default = {
  AssetType: {
    _enum: ['Usable', 'Locked', 'Reserved', 'ReservedWithdrawal', 'ReservedDexSpot', 'ReservedXRC20']
  },
  Chain: {
  ...
  OrderStatus: {
    _enum: ['Created', 'ParitialFill', 'Filled', 'ParitialFillAndCanceled', 'Canceled']
  },
  // eslint-disable-next-line sort-keys
  MiningWeight: 'u128',
  RpcBalance: 'String',
  ...
  TotalAssetInfoForRpc: {
    ...
    isOnline: 'bool' // restrictions: 'AssetRestrictions'
