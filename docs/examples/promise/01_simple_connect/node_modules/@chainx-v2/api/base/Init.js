...
var _Extrinsic = require("@chainx-v2/types/extrinsic/Extrinsic");

var _typesKnown = require("@chainx-v2/types-known");
  ...
  constructor(options, type, decorateMethod) {
    ...
    Object.defineProperty(this, _onProviderConnect, {
      ...
      value: async () => {
        ...
        try {
          const [hasMeta, cryptoReady] = await Promise.all([this._loadMeta(), this._options.initWasm === false ? Promise.resolve(true) : (0, _crypto.cryptoWaitReady)()]);
    ...
    options.types = _objectSpread(_objectSpread({}, _chainxTypes.default), options.types);
