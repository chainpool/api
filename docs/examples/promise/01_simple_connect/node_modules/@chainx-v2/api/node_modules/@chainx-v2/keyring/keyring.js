...
class Keyring {
  constructor(options = {}) {
    ...
    this.decodeAddress = _crypto.decodeAddress;

    this.encodeAddress = (address, ss58Format) => {
      return (0, _crypto.encodeAddress)(address, (0, _util.isUndefined)(ss58Format) ? (0, _classPrivateFieldLooseBase2.default)(this, _ss)[_ss] : ss58Format);
    };
  ...
  createFromUri(_suri, meta = {}, type = this.type) {
    ...
    if ((0, _util.isHex)(phrase, 256)) {
      ...
      if ([12, 15, 18, 21, 24].includes(parts.length)) {
        ...
        seed = (0, _crypto.mnemonicToMiniSecret)(phrase, password);
      } else {
    ...
    const derived = (0, _crypto.keyFromPath)(keypair[type](), path, type);
