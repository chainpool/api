...
var _apiDerive = _interopRequireDefault(require("@chainx-v2/api-derive"));

var _util = require("@chainx-v2/api-derive/util");

var _Decorated = _interopRequireDefault(require("@chainx-v2/metadata/Decorated"));

var _rpcCore = _interopRequireDefault(require("@chainx-v2/rpc-core"));

var _rpcProvider = require("@chainx-v2/rpc-provider");

var _types = require("@chainx-v2/types");

var _Linkage = require("@chainx-v2/types/codec/Linkage");

var _constants = require("@chainx-v2/types/extrinsic/constants");

var _StorageKey = require("@chainx-v2/types/primitive/StorageKey");

var _util2 = require("@chainx-v2/util");
...
class Decorate extends _Events.default {
  ...
  constructor(options, type, decorateMethod) {
    ...
    options.rpc = _objectSpread(_objectSpread({}, _chainxRpc.default), options.rpc);
