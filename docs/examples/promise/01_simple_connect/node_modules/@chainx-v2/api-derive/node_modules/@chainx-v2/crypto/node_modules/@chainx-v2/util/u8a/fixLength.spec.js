...
describe('u8aFixLength', () => {
  it('returns bitLength === -1 as-is', () => {
    expect((0, _.u8aFixLength)(new Uint8Array([0x12, 0x34, 0x56, 0x78]))).toEqual(new Uint8Array([0x12, 0x34, 0x56, 0x78]));
  });
  it('does not change when bitlength === length', () => {
    expect((0, _.u8aFixLength)(new Uint8Array([0x12, 0x34, 0x56, 0x78]), 32)).toEqual(new Uint8Array([0x12, 0x34, 0x56, 0x78]));
  });
