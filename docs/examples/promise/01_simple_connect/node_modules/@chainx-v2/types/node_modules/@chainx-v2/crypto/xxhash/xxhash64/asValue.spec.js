...
describe('xxhash64AsValue', () => {
  ...
  it('creates the correct output (Buffer input)', () => {
    expect((0, _asValue.default)(Buffer.from([0x61, 0x62, 0x63, 0x64]), 0xabcd).toString(16)).toEqual('e29f70f8b8c96df7');
  });
  it('creates the correct output (Uint8Array input)', () => {
    expect((0, _asValue.default)(new Uint8Array([0x61, 0x62, 0x63, 0x64]), 0xabcd).toString(16)).toEqual('e29f70f8b8c96df7');
  });
});