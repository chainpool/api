...
describe('secp256k1Recover', () => {
  it('recovers a publicKey', () => {
    ...
    const res = (0, _keccak.keccakAsU8a)((0, _index.secp256k1Recover)((0, _util.u8aToU8a)(msg), (0, _util.u8aToU8a)(sig), 0));
    expect((0, _util.u8aToHex)(res.subarray(12))).toEqual(pubKey);
  });
});