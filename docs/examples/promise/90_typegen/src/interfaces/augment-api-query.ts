...
import { BalanceLock, VestingSchedule } from '@chainx-v2/types/interfaces/balances';
...
import { CodeHash, ContractInfo, Gas, PrefabWasmModule, Schedule } from '@chainx-v2/types/interfaces/contracts';
import { Conviction, PropIndex, Proposal, ReferendumIndex, ReferendumInfo } from '@chainx-v2/types/interfaces/democracy';
import { Vote, VoteThreshold } from '@chainx-v2/types/interfaces/elections';
import { AuthorityList, SetId, StoredPendingChange, StoredState } from '@chainx-v2/types/interfaces/grandpa';
...
import { Kind, OffenceDetails, OpaqueTimeSlot, ReportIdOf } from '@chainx-v2/types/interfaces/offences';
import { AccountId, AccountIndex, Balance, BalanceOf, BlockNumber, Hash, Index, KeyTypeId, Moment, Perbill, ValidatorId, Weight } from '@chainx-v2/types/interfaces/runtime';
...
import { EraIndex, EraPoints, Exposure, Forcing, MomentOf, Nominations, RewardDestination, SlashingSpans, SpanIndex, SpanRecord, StakingLedger, UnappliedSlash, ValidatorPrefs } from '@chainx-v2/types/interfaces/staking';
import { DigestOf, EventIndex, EventRecord } from '@chainx-v2/types/interfaces/system';
